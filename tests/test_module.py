...
# as shown at https://minitensor.github.io/modules.html
# and checks that its properties work.


class ModuleA1(minitensor.Module):
    def __init__(self) -> None:
        super().__init__()
        self.p1 = minitensor.Parameter(5)
        self.non_param = 10
        self.a = ModuleA2()
        self.b = ModuleA3()


class ModuleA2(minitensor.Module):
    def __init__(self) -> None:
        super().__init__()
        self.p2 = minitensor.Parameter(10)


class ModuleA3(minitensor.Module):
    def __init__(self) -> None:
        super().__init__()
        self.c = ModuleA4()


class ModuleA4(minitensor.Module):
    def __init__(self) -> None:
        super().__init__()
        self.p3 = minitensor.Parameter(15)
...
class Module1(minitensor.Module):
    def __init__(self, size_a: int, size_b: int, val: float) -> None:
        super().__init__()
        self.module_a = Module2(size_a)
        self.module_b = Module2(size_b)
        self.parameter_a = minitensor.Parameter(val)


class Module2(minitensor.Module):
    def __init__(self, extra: int = 0) -> None:
        super().__init__()
        self.parameter_a = minitensor.Parameter(VAL_A)
        self.parameter_b = minitensor.Parameter(VAL_B)
...
class Module3(minitensor.Module):
    def __init__(self) -> None:
        super().__init__()
        self.parameter_a = minitensor.Parameter(VAL_A)
...
class ModuleRun(minitensor.Module):
